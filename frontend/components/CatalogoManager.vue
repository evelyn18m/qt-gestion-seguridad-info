      ...
      <div class="modal-card">
        ...
        <div class="modal-body">
          <div v-for="field in campos" :key="field" class="form-group">
            ...
            <input v-if="field !== 'descripcion' && field !== 'criterio' && field !== 'observaciones'"
                   :id="'f-' + field" v-model="formData[field]" type="text"/>
        ...
        <div class="modal-footer">
          ...
          <button :disabled="saving" class="btn-primary" @click="saveItem">
    ...
    <div v-if="confirmDeleteItem" class="modal-overlay" @click.self="confirmDeleteItem = null">
      <div class="modal-confirm">
        ...
        <div class="modal-body">
          ...
          <p class="confirm-detail">#{{ confirmDeleteItem.id }} &mdash;
            {{ campos.map(f => confirmDeleteItem && confirmDeleteItem[f]).filter(Boolean).join(' &mdash; ') }}</p>
        </div>
        <div class="modal-footer">
