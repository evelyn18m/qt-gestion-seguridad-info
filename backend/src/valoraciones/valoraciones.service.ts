  ...
  private async enrich(
    ...
    const detallesRiesgo = await this.prisma.detalleRiesgo.findMany({
      ...
      select: {
        ...
        catalogoId: true,
        riesgoId: true,
        vulnerabilidadRiesgoId: true,
        evaluacionRiesgo: true,
        nivelRiesgo: true,
        metodoTratamiento: true,
        tipoControlId: true,
        riesgoControlId: true,
        vulnerabilidadControlId: true,
        evaluacionRiesgoControl: true,
        nivelRiesgoControl: true,
        riesgoResidual: true,
        amenazaIds: true,
        vulnerabilidadIds: true,
        controlesImplementados: true,
        controlesArea: true,
        controlesImplementarId: true,
        createdAt: true,
        updatedAt: true,
      },
    });
