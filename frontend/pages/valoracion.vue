...
import { getCatalogoLabel as getCatalogoLabelFromUtils, calcularEvaluacionRiesgo, calcularNivelRiesgo, getNivelStyle, getMaxNivelIndex, getNivelFromIndex } from '~/utils/riskCalculations'
